...
public class MoveWords{
    ...
    private static final String[] validMoves = {"TIJERAS", "PIEDRA", "SPOCK", "PAPEL", "LAGARTIJA"};
    ...
    public static int checkWinner(String first, String second){
	    ...
	    return (( (first_i +1) % validMoves.length ) == second_i || ( (first_i +2) % validMoves.length ) == second_i ) ? PIERDE: GANA; 
